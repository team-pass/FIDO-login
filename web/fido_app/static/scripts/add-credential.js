...
const addBiometric = document.getElementById("add-biometric")
...
const startBiometricRegistration = async (formData) => {
  event.preventDefault();
  let formData = new FormData(); // ??? we don't have a registration form?
...
addBiometric.addEventListener("click", submitRegistrationForm);
